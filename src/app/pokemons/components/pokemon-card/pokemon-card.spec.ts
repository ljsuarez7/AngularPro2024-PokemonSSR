...
describe('PokemonCardComponent', () => {
  ...
  it('should render the pokemon name and image correctly', () => {
    ...
    expect(compiled.textContent?.trim()).toBe(mockPokemon.name); //Esto es para sacar todo el texto del componente, seria mejor ir directamente al h2, pero es un ejemplo
  });
